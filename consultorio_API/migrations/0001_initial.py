    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "motivo",
                    models.TextField(blank=True, help_text="Motivo de la consulta"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tipo",
                    models.CharField(
                        choices=[("con_cita", "Con Cita"), ("sin_cita", "Sin Cita")],
                        max_length=20,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        max_digits=6,
                        null=True,
                        verbose_name="Circ. abdominal (cm)",
                    ),
                ),
                (
                    "imc",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        null=True,
                        verbose_name="Síntomas o padecimientos actuales",
                    ),
                ),
                (
                    "consulta",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url_accion",
                    models.URLField(
                        blank=True, help_text="URL para redirigir al hacer clic"
                    ),
                ),
                (
                    "texto_accion",
                    models.CharField(
                        blank=True, help_text="Texto del botón de acción", max_length=50
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="medicamentos_actuales",
                        to="consultorio_API.expediente",
                    ),
                ),
            ],
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["destinatario", "leido"], name="consultorio_destina_9d0ff7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notificacion",
            index=models.Index(
                fields=["categoria", "fecha"], name="consultorio_categor_8efbe6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notificacion",
            index=models.Index(
                fields=["tipo", "fecha"], name="consultorio_tipo_9cc172_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="cita",
            index=models.Index(
                fields=["fecha_hora"], name="consultorio_fecha_h_0e6a88_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="cita",
        ...
        migrations.AddIndex(
            model_name="cita",
            index=models.Index(
                fields=["consultorio", "fecha_hora"],
                name="consultorio_consult_150a4f_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="cita",
            index=models.Index(
                fields=["paciente", "fecha_hora"], name="consultorio_pacient_208d67_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="cita",
            index=models.Index(
                fields=["medico_asignado", "fecha_hora"],
                name="consultorio_medico__161c0c_idx",
            ),
        ),
    ]
